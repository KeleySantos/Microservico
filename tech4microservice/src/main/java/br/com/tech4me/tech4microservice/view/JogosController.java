package br.com.tech4me.tech4microservice.view;
...
import br.com.tech4me.tech4microservice.service.JogosService;
import br.com.tech4me.tech4microservice.shared.JogosDto;
import br.com.tech4me.tech4microservice.view.model.Jogos;
import br.com.tech4me.tech4microservice.view.model.JogosModeloRequest;
import br.com.tech4me.tech4microservice.view.model.JogosModeloResponse;
...
public class JogosController {
    ...
    public ResponseEntity<JogosModeloResponse> criarJogo(@RequestBody @Valid JogosModeloRequest jogo) {
        ...
        dto = service.cadastrarJogo(dto);
        return new ResponseEntity<>(mapper.map(dto, JogosModeloResponse.class), HttpStatus.CREATED);
    }
    
    @GetMapping
    public ResponseEntity<List<JogosModeloResponse>> obterTodos() {
        List<JogosDto> dtos = service.obterTodos();
    ...
    @GetMapping(value="/{id}")
    public ResponseEntity<JogosModeloResponse> obterJogoPorId(@PathVariable String id) {
        Optional<JogosDto> jogo = service.obterJogoPorId(id);

        if(jogo.isPresent()) {
            return new ResponseEntity<>(
                new ModelMapper().map(jogo.get(), JogosModeloResponse.class), 
                HttpStatus.OK
            );
        }
